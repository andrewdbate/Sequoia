...
/** CLI command to check and report the consistency of an ontology.
  *
  * @author Andrew Bate <code@andrewbate.com>
  */
final class CLICommandConsistency extends CLICommand {

  override val taskName = "consistency"
  ...
  override def run {
    ...
    if (isConsistent) output("Consistent: Yes")
    else output("Consistent: No")
